...
## インストール方法
[Releases](https://github.com/scry1-csv/Scry1CsvGenerator/releases/)からダウンロード・解凍してexeを実行してください。
...
- 2026.4.6 v0.0.2 新しい行を編集中にクラッシュする問題を修正
- 2026.4.6 v0.0.1 チャート表示を追加
